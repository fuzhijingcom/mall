...
<body>
    ...
    <div class="weui-msg__text-area">
        <h2 class="weui-msg__title">{{ Inspiring::quote() }}</h2>
        <p class="weui-msg__desc">感谢你对我们的关注与支持，我们会认真处理你的订单。</p>
    </div>
    <div class="weui-msg__opr-area">
        <p class="weui-btn-area">
            <a href="{{ url('/user/id') }}" class="weui-btn weui-btn_primary" >查看我的ID</a>
        </p>
    </div>
</div></div></div>
